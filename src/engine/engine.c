...
#define ATK_NORTH               1
#define ATK_NORTHEAST           2
#define ATK_EAST                4
#define ATK_SOUTHEAST           8
#define ATK_SOUTH               16
#define ATK_SOUTHWEST           32
#define ATK_WEST                64
#define ATK_NORTHWEST           128
...
#define MAX_EL_LEN 8
void static _swap(void *v1, void *v2, size_t size)
{
...
void qsort(void *bse, size_t nitems, size_t size, int (*compar)(const void *, const void *))
{
    ...
    for (gap = nitems >> 1; gap > 0; gap >>= 1)
    {
        ...
        for (i = gap; i < nitems; ++i)
            for (p = bse + i * size - byte_gap; p >= bse; p -= byte_gap)
            {
